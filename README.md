...
• Developed an interactive analytics dashboard with Recharts and downloadable AI-generated PDF reports.

• Designed the application for cloud deployment using Vercel for frontend hosting, Render for backend APIs, and MongoDB Atlas for persistent storage.
